...
`timescale 1 ps / 1 ps
module AXI_DMA_mm_interconnect_0 (
		...
		input  wire [11:0]  msgdma_0_mm_read_address,                              //                                msgdma_0_mm_read.address
	...
	wire          rsp_mux_001_src_valid;                                                 // rsp_mux_001:src_valid -> msgdma_0_mm_read_agent:rp_valid
	wire  [110:0] rsp_mux_001_src_data;                                                  // rsp_mux_001:src_data -> msgdma_0_mm_read_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                 // msgdma_0_mm_read_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                               // rsp_mux_001:src_channel -> msgdma_0_mm_read_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                         // rsp_mux_001:src_startofpacket -> msgdma_0_mm_read_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                           // rsp_mux_001:src_endofpacket -> msgdma_0_mm_read_agent:rp_endofpacket
	...
	wire  [111:0] msgdma_0_csr_agent_rf_source_data;                                     // msgdma_0_csr_agent:rf_source_data -> msgdma_0_csr_agent_rsp_fifo:in_data
	...
	wire  [111:0] msgdma_0_csr_agent_rsp_fifo_out_data;                                  // msgdma_0_csr_agent_rsp_fifo:out_data -> msgdma_0_csr_agent:rf_sink_data
	...
	wire  [219:0] msgdma_0_descriptor_slave_agent_rf_source_data;                        // msgdma_0_descriptor_slave_agent:rf_source_data -> msgdma_0_descriptor_slave_agent_rsp_fifo:in_data
	...
	wire  [219:0] msgdma_0_descriptor_slave_agent_rsp_fifo_out_data;                     // msgdma_0_descriptor_slave_agent_rsp_fifo:out_data -> msgdma_0_descriptor_slave_agent:rf_sink_data
	...
	wire  [110:0] mm_master_bfm_0_m0_agent_cp_data;                                      // mm_master_bfm_0_m0_agent:cp_data -> router:sink_data
	...
	wire  [110:0] msgdma_0_mm_read_agent_cp_data;                                        // msgdma_0_mm_read_agent:cp_data -> router_001:sink_data
	...
	wire  [110:0] msgdma_0_csr_agent_rp_data;                                            // msgdma_0_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [218:0] msgdma_0_descriptor_slave_agent_rp_data;                               // msgdma_0_descriptor_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [110:0] onchip_memory2_0_s1_agent_rp_data;                                     // onchip_memory2_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [110:0] router_src_data;                                                       // router:src_data -> mm_master_bfm_0_m0_limiter:cmd_sink_data
	...
	wire  [110:0] mm_master_bfm_0_m0_limiter_cmd_src_data;                               // mm_master_bfm_0_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [110:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> mm_master_bfm_0_m0_limiter:rsp_sink_data
	...
	wire  [110:0] mm_master_bfm_0_m0_limiter_rsp_src_data;                               // mm_master_bfm_0_m0_limiter:rsp_src_data -> mm_master_bfm_0_m0_agent:rp_data
	...
	wire  [110:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> msgdma_0_csr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                     // msgdma_0_csr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                   // cmd_mux:src_channel -> msgdma_0_csr_burst_adapter:sink0_channel
	...
	wire  [110:0] msgdma_0_csr_burst_adapter_source0_data;                               // msgdma_0_csr_burst_adapter:source0_data -> msgdma_0_csr_agent:cp_data
	wire          msgdma_0_csr_burst_adapter_source0_ready;                              // msgdma_0_csr_agent:cp_ready -> msgdma_0_csr_burst_adapter:source0_ready
	wire    [2:0] msgdma_0_csr_burst_adapter_source0_channel;                            // msgdma_0_csr_burst_adapter:source0_channel -> msgdma_0_csr_agent:cp_channel
	...
	wire  [218:0] msgdma_0_descriptor_slave_burst_adapter_source0_data;                  // msgdma_0_descriptor_slave_burst_adapter:source0_data -> msgdma_0_descriptor_slave_agent:cp_data
	...
	wire    [2:0] msgdma_0_descriptor_slave_burst_adapter_source0_channel;               // msgdma_0_descriptor_slave_burst_adapter:source0_channel -> msgdma_0_descriptor_slave_agent:cp_channel
	...
	wire  [110:0] cmd_mux_002_src_data;                                                  // cmd_mux_002:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [110:0] onchip_memory2_0_s1_burst_adapter_source0_data;                        // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [218:0] router_003_src_data;                                                   // router_003:src_data -> msgdma_0_descriptor_slave_rsp_width_adapter:in_data
	...
	wire  [110:0] msgdma_0_descriptor_slave_rsp_width_adapter_src_data;                  // msgdma_0_descriptor_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire    [2:0] msgdma_0_descriptor_slave_rsp_width_adapter_src_channel;               // msgdma_0_descriptor_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [110:0] cmd_mux_001_src_data;                                                  // cmd_mux_001:src_data -> msgdma_0_descriptor_slave_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                                 // msgdma_0_descriptor_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                               // cmd_mux_001:src_channel -> msgdma_0_descriptor_slave_cmd_width_adapter:in_channel
	...
	wire  [218:0] msgdma_0_descriptor_slave_cmd_width_adapter_src_data;                  // msgdma_0_descriptor_slave_cmd_width_adapter:out_data -> msgdma_0_descriptor_slave_burst_adapter:sink0_data
	...
	wire    [2:0] msgdma_0_descriptor_slave_cmd_width_adapter_src_channel;               // msgdma_0_descriptor_slave_cmd_width_adapter:out_channel -> msgdma_0_descriptor_slave_burst_adapter:sink0_channel
	...
	AXI_DMA_mm_interconnect_0_router router (
	...
	AXI_DMA_mm_interconnect_0_router_001 router_001 (
	...
	AXI_DMA_mm_interconnect_0_router_002 router_002 (
	...
	AXI_DMA_mm_interconnect_0_router_003 router_003 (
	...
	AXI_DMA_mm_interconnect_0_router_004 router_004 (
	...
	AXI_DMA_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                         //        clk.clk
		.reset              (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                         //       clk.clk
		.reset               (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                         //       clk.clk
		.reset               (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                         //       clk.clk
		.reset               (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                         //       clk.clk
		.reset               (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                         //       clk.clk
		.reset               (mm_master_bfm_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AXI_DMA_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	AXI_DMA_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (130),
		.inUsePackets    (0),
		.inDataWidth     (130),
		.inChannelWidth  (0),
